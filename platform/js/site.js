function Site(data){
    ...
    self.registerEvent = function(event, cb){
        console.log("New Event Listener: ", event, cb);
    ...
    self._triggerEvent = function(event, server){
        ...
        console.log("Triggering Event: ", event, e);
    ...
    self.load = function(servers){
        ...
        console.log("Importing new datas", servers);
        var newbies = [];
    ...
    self._deleteServer = function(id){
        ...
        console.log("Deleting Server", id, toDelete);
