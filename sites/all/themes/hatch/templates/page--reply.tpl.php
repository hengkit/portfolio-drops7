...
<div id="container">
    ...
    <!--</div><!--closing of menu-primary div-->
      ...
      <div id="sidebar-subsidiary" class="sidebar">
        ...
        <div id="hybrid-tags-2" class="widget tags widget-tags"><?php if ($page['tags']): ?><div class="widget-wrap widget-inside grid-4">
          <?php print render($page['tags']); ?> </div><?php endif;?></div>
          <div id="hybrid-calendar-2" class="widget calendar widget-calendar"><?php if ($page['calendar']): ?>
      	    <div class="widget-wrap widget-inside grid-4"> <?php print render($page['calendar']); ?></div><?php endif;?>
          </div>
